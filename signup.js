...
signupForm.addEventListener("submit", function (e) {
   ...
   if (validateForm()) {
      signupSuccessAlert.textContent = "Form submitted successfully";
...
function validateForm() {
   ...
   if (usernameInput.value < 3) {
      usernameError.textContent = "Username should be at least 3 chars";
      isValid = false;
   }
   ...
   if (!passwordInput || passwordInput.value.length < 6) {
      passwordError.textContent = "Password should be at least 6 chars";
      isValid = false;
   }
